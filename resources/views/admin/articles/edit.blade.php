...
<form action="{{ route('admin.articles.update', $article->id) }}" method="POST">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 1.5rem;">
        <div>
            ...
            <h2 class="font-heading" style="font-size: 1.3rem;">Edit Artikel: "{{ $article->title }}"</h2>
        </div>
        <div style="display: flex; gap: 0.8rem;">
            <a href="{{ route('articles.show', $article->slug) }}" target="_blank" class="btn-secondary">
                <i class="fa-solid fa-eye"></i> Lihat di Site
            </a>
    ...
    <div class="form-grid">
        ...
        <div class="admin-card">
            ...
            <div class="form-group">
                ...
                <textarea name="content" style="min-height: 320px;" class="form-control" required>{{ old('content', $article->content) }}</textarea>
        ...
        <div style="display: flex; flex-direction: column; gap: 1.5rem;">
            <div class="admin-card">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="read_time" value="{{ old('read_time', $article->read_time) }}" class="form-control" required>
            ...
            <div class="admin-card">
                ...
                <div class="form-group">
                    <label class="form-label">URL Gambar <span>*</span></label>
                    <input type="url" name="image_url" id="image_url" value="{{ old('image_url', $article->image_url) }}" class="form-control" required>
                ...
                <div class="image-preview-container">
                    <img id="img-preview" src="{{ old('image_url', $article->image_url) }}" alt="Preview" onerror="this.style.display='none'; document.getElementById('preview-fallback').style.display='block';">
